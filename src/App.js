    ...
    <div className="wrapper bg-white rounded-[20px] min-w-[700px] w-full flex flex-col p-[20px]">
      <div className="overlay">
        <div className="drawer">
          <h2 className="flex justify-between">Корзина <img
                className="removeBtn"
        ...
        <div className="goods">
          ...
          <div className="card">
            <img
              width={133}
              height={112}
              src="/img/clothes/sneakers/image1.jpg"
              alt="Мужские кроссовки Nike Blazer Mid Suede"
            />
            <p>Мужские кроссовки Nike Blazer Mid Suede</p>
            <div>
          ...
          <div className="card">
            <img
              width={133}
              height={112}
              src="/img/clothes/sneakers/image2.jpg"
              alt="Мужские кроссовки Nike Blazer Mid Suede"
            />
            <p>Мужские кроссовки Nike Blazer Mid Suede</p>
            <div>
          ...
          <div className="card">
            <img
              width={133}
              height={112}
              src="/img/clothes/sneakers/image3.jpg"
              alt="Мужские кроссовки Nike Blazer Mid Suede"
            />
            <p>Мужские кроссовки Nike Blazer Mid Suede</p>
            <div>
          ...
          <div className="card">
            <img
              width={133}
              height={112}
              src="/img/clothes/sneakers/image4.jpg"
              alt="Мужские кроссовки Nike Blazer Mid Suede"
            />
            <p>Мужские кроссовки Nike Blazer Mid Suede</p>
            <div>
          ...
          <div className="card">
            <img
              width={133}
              height={112}
              src="/img/clothes/sneakers/image5.jpg"
              alt="Мужские кроссовки Nike Blazer Mid Suede"
            />
            <p>Мужские кроссовки Nike Blazer Mid Suede</p>
            <div>
